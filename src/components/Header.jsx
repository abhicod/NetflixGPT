      ...
      <div className="flex justify-between items-center">
        ...
        <div>
          <div className="flex items-center gap-4">
            {user && <img className="w-10 rounded-md"
            ...
            />}
            <Link to="/login">
              <button onClick={handleSignOut} className="bg-red-600 font-semibold text-white px-4 py-1 rounded-md hover:bg-red-700 transition-all duration-100 cursor-pointer">
                {user ? "Log Out" : "Log In"}
              </button>
            </Link>
          </div>
