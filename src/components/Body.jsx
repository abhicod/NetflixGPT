            ...
            <div className='w-full h-screen absolute top-0 left-0 bg-black/70'>
             <div className='flex flex-col justify-center items-center h-full gap-4 w-full'>
                ...
                <div className='flex w-1/2 gap-2 m-1' >
                  <input className='w-3/4 py-3 px-5 rounded-lg border border-gray-300 focus:outline-none bg-black/20 placeholder:text-gray-300 focus:text-white focus:border-white focus:ring-2 focus:ring-red-700 ' type="text" placeholder='Enter your email' />
